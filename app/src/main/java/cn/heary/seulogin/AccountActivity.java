    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AccountActivity.this, username+password+isMacAuth.toString(), Toast.LENGTH_SHORT).show();
//                attemptLogin();
            }
        });
        ...
        mLogoutBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AccountActivity.this, getString(R.string.action_logout), Toast.LENGTH_SHORT).show();
//                attemptLogin();
            }
        });
